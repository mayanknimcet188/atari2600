...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    ...
    include "macro.h"
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;; Start an uninitialized segent at $80 for variable declaration.
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    ...
    seg.u Variables
    org $80
P0Height      byte     ;player sprite P0Height
PlayerYPos    byte     ;player sprite Y co-ordinate
...
Reset:
    ...
    ldx #$00
    stx COLUBK    ;black backgorund color
...
Scanline:
    txa     ;transfer X to A
    sec     ;make sure carry flag is set before subtaction operation
    sbc PlayerYPos  ; subtract sprite Y coordinate
    cmp P0Height    ;are we inside the sprite heihgt bounds
