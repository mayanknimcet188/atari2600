...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;; Uninitialized variables segment at $80
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    seg.u Variables
    org $80
P0XPos byte       ;sprite X co-ordinate
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    lda #10
    sta P0XPos        ;initialize zplayer X co-ordinate
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    ...
    sta HMCLR       ;clear old horizontal postiton

    sec             ;set the carry flag before subtaction
DivideLoop:
    sbc #15         ;subtract 15 from the accumulator
    bcs DivideLoop  ;loop while the carry flag is still Set

    eor #7          ;to adjust the remainder withini -8 and 7
    asl             ;shift left by 4, as HMP0 useus only 4 bits
    asl
    asl
    asl
...
DrawBitmap:
    ...
    sta GRP0        ;set graphics of player 0 slice
    ...
    lda #0
    sta GRP0        ;diable P0 bitmap graphics
